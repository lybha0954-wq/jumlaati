...
const MOCK_BARCODE_LOOKUP: Record<string, any> = {
  '62810001': {
    ...
    unit: 'كرتون',
    image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1cc05468a-1786758828017.png',
...
export default function SupplierCatalogContent() {
  ...
  const getMockProducts = (): Product[] => [
    ...
    },
    {
      ...
      status: 'out_of_stock',
      barcode: '62810001',
      image_url: 'https://img.rocket.new/generatedImages/rocket_gen_img_1cc05468a-1786758828017.png',
      sold_count: 85
    }
  ];
