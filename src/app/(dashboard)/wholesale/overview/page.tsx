    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow space-y-4">
          ...
          <div className="flex justify-between"><span>إجمالي الإيرادات:</span><strong>{formatCurrency(18000000)}</strong></div>
          <div className="flex justify-between"><span>المشتريات بالجملة:</span><strong>120</strong></div>
