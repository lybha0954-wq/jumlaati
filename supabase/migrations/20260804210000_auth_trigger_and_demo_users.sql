-- Migration: Auth trigger + demo users for Jumlaati
-- Adds handle_new_user trigger and seeds demo accounts

-- 1. Trigger function: auto-create user_profiles row on auth.users INSERT
...
-- 3. RLS policies for user_profiles (idempotent)
...
-- 4. Demo users (retailer, supplier, admin)
DO $$
DECLARE
