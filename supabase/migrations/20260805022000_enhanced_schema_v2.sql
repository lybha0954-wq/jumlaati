                                    ...
                                    retailer_id UUID REFERENCES public.user_profiles(id) ON DELETE SET NULL,
                                      supplier_id UUID REFERENCES public.user_profiles(id) ON DELETE SET NULL,
                                        order_id UUID REFERENCES public.orders(id) ON DELETE SET NULL,
                                          invoice_id UUID DEFAULT NULL, -- Flexible reference to avoid migration missing-table block
                              ...
                              ADD COLUMN IF NOT EXISTS link_url TEXT DEFAULT '',
                                ADD COLUMN IF NOT EXISTS role_target TEXT DEFAULT 'all'
                                    ...
                                    AS $$
                                      ...
                                      -- Global Barcode Lookup (for scanner integration)
                                                                                                                          ...
                                                                                                                          p.delivery_days
                                                                                                                            FROM public.products p
                                                                                                                              WHERE p.barcode = barcode_value
                                                                                                                                ...
                                                                                                                                -- Supplier-Scoped Barcode Lookup
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    AND p.supplier_id = supplier_uuid
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      BEGIN
                                                                                                                                                                                                        NEW.updated_at = CURRENT_TIMESTAMP;
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          -- Ensure general read access for products is active
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.products; EXCEPTION WHEN duplicate_object THEN NULL; END;
                                                                                                                                                                                                                    BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.orders; EXCEPTION WHEN duplicate_object THEN NULL; END;
                                                                                                                                                                                                                      BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.order_items; EXCEPTION WHEN duplicate_object THEN NULL; END;
                                                                                                                                                                                                                        BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.supplier_orders; EXCEPTION WHEN duplicate_object THEN NULL; END;
                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                              t4 UUID := gen_random_uuid();
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                BEGIN
                                                                                                                                                                                                                                                  SELECT id INTO admin_user_id FROM public.user_profiles WHERE role = 'admin' LIMIT 1;
                                                                                                                                                                                                                                                    SELECT id INTO supplier_user_id FROM public.user_profiles WHERE role = 'supplier' LIMIT 1;
                                                                                                                                                                                                                                                      SELECT id INTO retailer_user_id FROM public.user_profiles WHERE role = 'retailer' LIMIT 1;
                                                                                                                                                                                                                                                        SELECT id INTO first_order_id FROM public.orders LIMIT 1;

                                                                                                                                                                                                                                                          IF admin_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                              UPDATE public.user_profiles
                                                                                                                                                                                                                                                                  SET phone = '07901000001', business_name = 'إدارة منصة جملاتي', governorate = 'بغداد', district = 'الكرادة', account_status = 'active'
                                                                                                                                                                                                                                                                      WHERE id = admin_user_id;
                                                                                                                                                                                                                                                                        END IF;

                                                                                                                                                                                                                                                                          IF supplier_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                              UPDATE public.user_profiles
                                                                                                                                                                                                                                                                                  SET phone = '07901000002', business_name = 'مستودع الجبوري للتوزيع', governorate = 'بغداد', district = 'الشعب', account_status = 'active'
                                                                                                                                                                                                                                                                                      WHERE id = supplier_user_id;
                                                                                                                                                                                                                                                                                        END IF;

                                                                                                                                                                                                                                                                                          IF retailer_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                                              UPDATE public.user_profiles
                                                                                                                                                                                                                                                                                                  SET phone = '07901000003', business_name = 'سوبرماركت البقالي', governorate = 'بغداد', district = 'الكرخ', account_status = 'active'
                                                                                                                                                                                                                                                                                                      WHERE id = retailer_user_id;
                                                                                                                                                                                                                                                                                                        END IF;

                                                                                                                                                                                                                                                                                                          -- Apply Discounts for Offers
                                                                                                                                                                                                                                                                                                            UPDATE public.products
                                                                                                                                                                                                                                                                                                              SET discount_percentage = 10, discount_price = GREATEST(0, final_price - (final_price * 10 / 100)), is_on_offer = true, offer_start_date = CURRENT_TIMESTAMP - INTERVAL '2 days', offer_end_date = CURRENT_TIMESTAMP + INTERVAL '5 days'
                                                                                                                                                                                                                                                                                                                WHERE name LIKE '%نستله%' OR name LIKE '%كولا%';

                                                                                                                                                                                                                                                                                                                  UPDATE public.products
                                                                                                                                                                                                                                                                                                                    SET discount_percentage = 15, discount_price = GREATEST(0, final_price - (final_price * 15 / 100)), is_on_offer = true, offer_start_date = CURRENT_TIMESTAMP - INTERVAL '1 day', offer_end_date = CURRENT_TIMESTAMP + INTERVAL '7 days'
                                                                                                                                                                                                                                                                                                                      WHERE name LIKE '%شيبس%' OR name LIKE '%كيت كات%';

                                                                                                                                                                                                                                                                                                                        -- Seed Sample Transactions
                                                                                                                                                                                                                                                                                                                          IF retailer_user_id IS NOT NULL AND supplier_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                                                                              INSERT INTO public.transactions (
                                                                                                                                                                                                                                                                                                                                      id, transaction_number, retailer_id, supplier_id, order_id, total_amount, paid_amount, currency, payment_status, payment_method, due_date, notes
                                                                                                                                                                                                                                                                                                                              ) VALUES
                                                                                                                                                                                                                                                                                                                                    (t1, 'TXN-2026-0001', retailer_user_id, supplier_user_id, first_order_id, 1274000, 1274000, 'IQD', 'paid', 'cash', CURRENT_DATE, 'دفعة كاملة — طلب مياه وشيبس'),
                                                                                                                                                                                                                                                                                                                                          (t2, 'TXN-2026-0002', retailer_user_id, supplier_user_id, NULL, 860000, 430000, 'IQD', 'partial', 'bank_transfer', CURRENT_DATE + 7, 'دفعة جزئية — طلب مشروبات'),
                                                                                                                                                                                                                                                                                                                                                (t3, 'TXN-2026-0003', retailer_user_id, supplier_user_id, NULL, 456000, 0, 'IQD', 'overdue', 'cod', CURRENT_DATE - 3, 'مبلغ متأخر — طلب منظفات'),
                                                                                                                                                                                                                                                                                                                                                      (t4, 'TXN-2026-0004', retailer_user_id, supplier_user_id, NULL, 378000, 0, 'IQD', 'pending', 'cod', CURRENT_DATE + 14, 'طلب جديد — مياه معدنية وعصائر'),
                                                                                                                                                                                                                                                                                                                                                            (t5, 'TXN-2026-0005', retailer_user_id, supplier_user_id, NULL, 640000, 640000, 'IQD', 'paid', 'cash', CURRENT_DATE - 7, 'تسوية كاملة — طلب ألبان وجبن')
                                                                                                                                                                                                                                                                                                                                                                ON CONFLICT (id) DO NOTHING;
                                                                                                                                                                                                                                                                                                                                                                  END IF;

                                                                                                                                                                                                                                                                                                                                                                    -- Seed Sample Notifications
                                                                                                                                                                                                                                                                                                                                                                      IF admin_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                                                                                                                          INSERT INTO public.notifications (user_id, title_ar, title_en, message_ar, message_en, type, is_read, link_url, role_target)
                                                                                                                                                                                                                                                                                                                                                                              VALUES (admin_user_id, 'طلب موافقة جديد', 'New Approval Request', 'متجر سوبرماركت الفرات يطلب الانضمام للمنصة', 'Supermarket Al-Furat requests to join', 'system', false, '/admin-users', 'admin')
                                                                                                                                                                                                                                                                                                                                                                                  ON CONFLICT (id) DO NOTHING;
                                                                                                                                                                                                                                                                                                                                                                                    END IF;

                                                                                                                                                                                                                                                                                                                                                                                      IF supplier_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                                                                                                                                          INSERT INTO public.notifications (user_id, title_ar, title_en, message_ar, message_en, type, is_read, link_url, role_target)
                                                                                                                                                                                                                                                                                                                                                                                              VALUES (supplier_user_id, 'طلب جديد وارد', 'New Incoming Order', 'وصل طلب جديد من سوبرماركت الأمل بقيمة ٣٬٣١٢٬٠٠٠ د.ع', 'New order received from Supermarket Al-Amal', 'order', false, '/supplier-incoming-orders', 'supplier')
                                                                                                                                                                                                                                                                                                                                                                                                  ON CONFLICT (id) DO NOTHING;
                                                                                                                                                                                                                                                                                                                                                                                                    END IF;

                                                                                                                                                                                                                                                                                                                                                                                                      IF retailer_user_id IS NOT NULL THEN
                                                                                                                                                                                                                                                                                                                                                                                                          INSERT INTO public.notifications (user_id, title_ar, title_en, message_ar, message_en, type, is_read, link_url, role_target)
                                                                                                                                                                                                                                                                                                                                                                                                              VALUES (retailer_user_id, 'تحديث حالة طلبك', 'Order Status Update', 'طلبك رقم ORD-2026-1101 قيد التجهيز الآن', 'Your order ORD-2026-1101 is being processed', 'order', false, '/retailer-orders', 'retailer')
                                                                                                                                                                                                                                                                                                                                                                                                                  ON CONFLICT (id) DO NOTHING;
                                                                                                                                                                                                                                                                                                                                                                                                                    END IF;

                                                                                                                                                                                                                                                                                                                                                                                                                    EXCEPTION
                                                                                                                                                                                                                                                                                                                                                                                                                      WHEN OTHERS THEN
                                                                                                                                                                                                                                                                                                                                                                                                                          RAISE NOTICE 'Enhanced mock data insertion logged message: %', SQLERRM;
                                                                                                                                                                                                                                                                                                                                                                                                                          END $$;
