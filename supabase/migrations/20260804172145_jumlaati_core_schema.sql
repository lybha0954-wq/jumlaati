-- ============================================================
-- Jumlaati Platform — Core Schema Migration (Updated & Complete)
-- ============================================================
...
BEGIN
  ...
  -- Insert Products
  INSERT INTO public.products (id, barcode, name, category, cost_price, original_price, final_price, stock, min_order_qty, unit, supplier_id, supplier_name, supplier_rating, delivery_days, status)
  VALUES
    (p1, '628100100101', 'حليب نيدو مجفف 2.5 كجم', 'مواد غذائية', 18000, 20000, 22000, 150, 5, 'كرتون', sup1, 'مستودع الجبوري للترديد والإنتاج', 4.8, 1, 'متوفر'),
    (p2, '628100100102', 'رز بسمكي الهند الاصل 5 كجم', 'حبوب ومقرمشات', 12000, 14000, 15500, 80, 10, 'كيس', sup2, 'شركة الرافدين للتجارة العامة', 4.6, 2, 'متوفر')
  ON CONFLICT DO NOTHING;

  -- Insert Sample Order
  INSERT INTO public.orders (id, order_number, status, payment_status, buyer_name, buyer_store_name, buyer_phone, delivery_address, delivery_city, delivery_notes, subtotal, delivery_fee, total, commission, payment_method, store_id)
  VALUES
    (ord1, 'ORD-2026-0001', 'reviewing', 'pending', 'أحمد العبيدي', 'أسواق البركة المركزية', '07803000003', 'بغداد - الرصافة - شارع فلسطين', 'بغداد', 'يرجى الاتصال قبل التوصيل', 440000, 10000, 450000, 22000, 'local_wallet', store1)
  ON CONFLICT DO NOTHING;

  -- Insert Sample Order Items
  INSERT INTO public.order_items (order_id, product_id, name, qty, unit, unit_price)
  VALUES
    (ord1, p1, 'حليب نيدو مجفف 2.5 كجم', 20, 'كرتون', 22000)
  ON CONFLICT DO NOTHING;
